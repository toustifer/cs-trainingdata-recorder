...
function MilkdownEditor({ defaultValue, isResizable, autoFocus, placeholder, onReady, onBlur, onDestroy }) {
    useEditor((root) => {
    ...
    return React.createElement(Milkdown, null);
}
export function MarkdownEditor({ defaultValue, isResizable, placeholder, autoFocus, onReady, onBlur, onDestroy, }) {
    return (React.createElement(MilkdownProvider, null,
        React.createElement(MilkdownEditor, { isResizable: isResizable, defaultValue: defaultValue, placeholder: placeholder, autoFocus: autoFocus, onBlur: onBlur, onDestroy: onDestroy, onReady: onReady })));
}
