...
export function AddToVideoSequencesItem({ startTick, endTick, playerFocusSteamId, playerFocusName }) {
    ...
    return (React.createElement(ContextMenuItem, { onClick: onClick },
        React.createElement(Trans, { context: "Context menu" }, "Add to video sequences")));
}
//# sourceMappingURL=add-to-video-sequences-item.js.map