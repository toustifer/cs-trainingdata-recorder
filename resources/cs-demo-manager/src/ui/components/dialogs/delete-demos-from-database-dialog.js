...
export function DeleteDemosFromDatabaseDialog({ checksums }) {
    ...
    return (React.createElement(ConfirmDialog, { title: plural(checksums.length, {
            one: 'Delete demo',
            other: 'Delete demos',
...
//# sourceMappingURL=delete-demos-from-database-dialog.js.map