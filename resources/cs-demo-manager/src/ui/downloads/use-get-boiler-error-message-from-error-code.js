    ...
    return (message, errorCode) => {
        switch (errorCode) {
            ...
            case ErrorCode.BoilerCommunicationFailure:
                return t({
                    context: 'Boiler-writter error message',
                    message: 'Error while contacting Steam, make sure your Steam account is not currently in-game on another device, otherwise please retry later.',
                });
...
//# sourceMappingURL=use-get-boiler-error-message-from-error-code.js.map