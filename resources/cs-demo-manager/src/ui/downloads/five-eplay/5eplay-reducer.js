...
import { downloadDemoCorrupted, downloadsAdded, downloadDemoSuccess, downloadDemoError, downloadDemoExpired, } from '../downloads-actions';
...
import { accountAdded, accountsUpdated, fetchLastMatchesError, fetchLastMatchesStart, fetchLastMatchesSuccess, matchSelected, } from './5eplay-actions';
const initialState = {
    status: Status.Idle,
    accounts: [],
    matches: [],
...
//# sourceMappingURL=5eplay-reducer.js.map