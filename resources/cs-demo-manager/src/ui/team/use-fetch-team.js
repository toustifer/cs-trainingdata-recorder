...
export function useFetchTeam() {
    ...
    const { updateSettings, demoSources, games, demoTypes, gameModes, tagIds, maxRounds, startDate, endDate } = useTeamProfileSettings();
    return async (filters) => {
        try {
            ...
            dispatch(fetchTeamError({ errorCode: error }));
        }
    };
}
//# sourceMappingURL=use-fetch-team.js.map