...
import { TeamDeleteMatchesDialog } from './team-delete-matches-dialog';
...
export function TeamMatchContextMenu({ selectedMatches, matchChecksums, onCommentClick }) {
    ...
    const onDeleteClick = () => {
        showDialog(React.createElement(TeamDeleteMatchesDialog, { checksums: checksums }));
    };
    const onRenameClick = () => {
...
//# sourceMappingURL=team-match-context-menu.js.map