...
import { selectedMatchesChanged } from '../team-actions';
import { useSelectedMatchChecksums } from './use-selected-match-checksums';
import { useContextMenu } from 'csdm/ui/components/context-menu/use-context-menu';
import { TeamMatchContextMenu } from './team-match-context-menu';
...
export function TeamMatchesTable() {
    ...
    const onContextMenu = (event, table) => {
        showContextMenu(event, React.createElement(TeamMatchContextMenu, { onCommentClick: showWidget, selectedMatches: table.getSelectedRows(), matchChecksums: table.getRowIds() }));
    };
...
//# sourceMappingURL=team-matches-table.js.map