...
export function DatabaseSize() {
    ...
    return hasError ? (React.createElement("p", null,
        React.createElement(Trans, null, "An error occurred."))) : (React.createElement("p", null,
        React.createElement(Trans, null,
            "Database size: ",
            React.createElement("span", null, size),
            ".")));
}
//# sourceMappingURL=database-size.js.map