...
export function PitchInput() {
    ...
    return (React.createElement("div", { className: "flex flex-col gap-y-8" },
        React.createElement(InputLabel, { htmlFor: id },
            React.createElement(Trans, { context: "Input label" }, "Pitch")),
        React.createElement(CameraCoordinatesInputNumber, { id: id, name: "pitch", value: value, onChange: setField }),
        React.createElement(FieldError, { error: error })));
}
//# sourceMappingURL=pitch-input.js.map