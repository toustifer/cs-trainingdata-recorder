...
export function CoordinateZInput() {
    ...
    return (React.createElement("div", { className: "flex flex-col gap-y-8" },
        React.createElement(InputLabel, { htmlFor: id },
            React.createElement(Trans, { context: "Input label" }, "Coordinate Z")),
        React.createElement(CameraCoordinatesInputNumber, { id: id, name: "z", value: value, onChange: setField }),
        React.createElement(FieldError, { error: error })));
}
//# sourceMappingURL=coordinate-z-input.js.map