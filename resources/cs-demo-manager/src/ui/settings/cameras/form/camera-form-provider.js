...
export function CameraFormProvider({ children, id, game, mapName, initialValues }) {
    const { t } = useLingui();
    ...
    const tryUpdatingCoordinatesFromGameCommand = (command) => {
        try {
    ...
    return (React.createElement(CameraFormContext.Provider, { value: {
            id,
            game,
            mapName,
            fields,
...
//# sourceMappingURL=camera-form-provider.js.map