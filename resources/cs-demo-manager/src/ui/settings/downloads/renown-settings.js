...
function AddAccountDialog() {
    ...
    return (React.createElement(ConfirmDialog, { title: React.createElement(Trans, null, "Add Renown account"), onConfirm: onConfirm, closeOnConfirm: false, isBusy: isBusy },
...
export function RenownSettings() {
    ...
    const deleteAccount = async (steamId) => {
        try {
    ...
    return (React.createElement(ThirdPartySettings, { name: "Renown", logo: React.createElement(RenownLogo, { className: "-mt-4 h-20" }), autoDownloadAtStartupSettingsKey: "downloadRenownDemosAtStartup", autoDownloadInBackgroundSettingsKey: "downloadRenownDemosInBackground" },
...
//# sourceMappingURL=renown-settings.js.map