...
export function AutoDownloadThirdPartyDemos({ name, settingsKey }) {
    ...
    return (React.createElement(SettingsEntry, { interactiveComponent: React.createElement(Switch, { isChecked: download[settingsKey], onChange: onChange }), description: React.createElement(Trans, null,
            ...
            name,
            " demos at application startup."), title: React.createElement(Trans, { context: "Settings title" }, "Startup download") }));
}
//# sourceMappingURL=auto-download-third-party-demos.js.map