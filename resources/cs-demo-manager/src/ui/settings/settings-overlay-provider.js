...
export const SettingsOverlayContext = createContext({
    ...
    openSettings: () => {
        throw new Error('openSettings not implemented, make sure your component is rendered within a SettingsOverlayProvider');
    },
    showCategory: () => {
        throw new Error('showCategory not implemented, make sure your component is rendered within a SettingsOverlayProvider');
    },
    closeSettings: () => {
        throw new Error('closeSettings not implemented, make sure your component is rendered within a SettingsOverlayProvider');
    },
});
export function SettingsOverlayProvider({ children }) {
    ...
    return (React.createElement(SettingsOverlayContext.Provider, { value: {
            category,
            showCategory,
            openSettings,
            closeSettings,
        ...
        children,
        areSettingsVisible ? (React.createElement(DialogProvider, { inertElementId: SETTINGS_ELEMENT_ID },
            React.createElement(SettingsOverlay, { onClose: closeSettings }))) : null));
}
//# sourceMappingURL=settings-overlay-provider.js.map