...
export function RevealMatchesInExplorerButton() {
    ...
    return React.createElement(RevealDemoInExplorerButton, { isDisabled: !matchesLoaded, demoPath: demoPath });
}
//# sourceMappingURL=reveal-matches-in-explorer-button.js.map