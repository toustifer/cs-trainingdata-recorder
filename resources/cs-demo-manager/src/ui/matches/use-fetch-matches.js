...
export function useFetchMatches() {
    ...
    const { updateSettings, sources, games, gameModes, ranking, startDate, endDate, tagIds, maxRounds, demoTypes } = useMatchesSettings();
...
//# sourceMappingURL=use-fetch-matches.js.map