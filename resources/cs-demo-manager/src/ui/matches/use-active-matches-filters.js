...
export function useActiveMatchesFilters() {
    ...
    const hasActivePeriodFilter = defaultSettings.matches.startDate !== startDate || defaultSettings.matches.endDate !== endDate;
    const hasActiveFilter = hasActiveGamesFilter ||
...
//# sourceMappingURL=use-active-matches-filters.js.map