...
export function useActiveDemosFilters() {
    ...
    const hasActivePeriodFilter = defaultSettings.demos.startDate !== startDate || defaultSettings.demos.endDate !== endDate;
...
//# sourceMappingURL=use-active-demos-filters.js.map