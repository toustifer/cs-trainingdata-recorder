...
export function RemoveAnalysesSucceedButton() {
    ...
    return (React.createElement(Button, { isDisabled: isDisabled, onClick: onClick },
        React.createElement(Trans, null, "Remove succeed analyses")));
}
//# sourceMappingURL=remove-analyses-succeed-button.js.map