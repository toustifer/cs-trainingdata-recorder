...
export function useActivePlayerFilters() {
    const { demoSources, games, gameModes, demoTypes, ranking, tagIds, maxRounds, startDate, endDate } = usePlayerProfileSettings();
    ...
    const hasActivePeriodFilter = defaultSettings.playerProfile.startDate !== startDate || defaultSettings.playerProfile.endDate !== endDate;
    const hasActiveFilter = hasActiveSourcesFilter ||
...
//# sourceMappingURL=use-active-player-filters.js.map