...
export function PlayerLoader() {
    ...
    if (status === Status.Idle || status === Status.Loading) {
        return React.createElement(Message, { message: React.createElement(Trans, null, "Loading player\u2026") });
    }
    if (status === Status.Error) {
        return React.createElement(LoadPlayerError, { errorCode: errorCode });
    }
