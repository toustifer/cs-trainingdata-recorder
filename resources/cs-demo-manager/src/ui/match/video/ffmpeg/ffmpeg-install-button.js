...
export function FfmpegInstallButton() {
    ...
    const onClick = async () => {
        try {
            showToast({
                content: React.createElement(Trans, null, "Installing FFmpeg\u2026"),
            ...
            showToast({
                content: React.createElement(Trans, null, "FFmpeg has been installed"),
                id: 'ffmpeg-installation',
                type: 'success',
            });
        }
            ...
            showToast({
                content: React.createElement(Trans, null, "An error occurred while installing FFmpeg"),
                id: 'ffmpeg-installation',
                type: 'error',
            });
        }
    ...
    return React.createElement(InstallButton, { isDisabled: isDisabled, isInstalling: isInstalling, onClick: onClick });
}
//# sourceMappingURL=ffmpeg-install-button.js.map