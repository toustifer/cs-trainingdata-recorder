...
export function VirtualDubInstallButton() {
    ...
    const onClick = async () => {
        try {
            showToast({
                content: React.createElement(Trans, null, "Installing VirtualDub\u2026"),
                id: 'vb-installation',
            });
            ...
            showToast({
                content: React.createElement(Trans, null, "VirtualDub has been installed"),
                id: 'vb-installation',
                type: 'success',
            });
        }
            ...
            showToast({
                content: React.createElement(Trans, null, "An error occurred while installing VirtualDub"),
                id: 'vb-installation',
                type: 'error',
            });
        }
    ...
    return React.createElement(InstallButton, { isDisabled: isVirtualDubInstalled, isInstalling: isInstalling, onClick: onClick });
}
//# sourceMappingURL=virtual-dub-install-button.js.map