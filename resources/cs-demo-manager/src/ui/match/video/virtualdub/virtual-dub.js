...
export function VirtualDub() {
    ...
    return (React.createElement("div", { className: "rounded border border-gray-400 p-8" },
        React.createElement(Software, { name: "VirtualDub", websiteLink: "http://www.virtualdub.org/", version: virtualDubVersion },
            React.createElement(VirtualDubInstallButton, null),
            React.createElement(VirtualDubBrowseButton, null))));
}
//# sourceMappingURL=virtual-dub.js.map