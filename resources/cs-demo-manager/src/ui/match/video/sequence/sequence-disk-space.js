...
export function SequenceDiskSpace() {
    ...
    return (React.createElement("span", { className: requiredDiskSpace >= minimumGigabyteWarning ? 'text-red-600' : undefined },
        React.createElement(Trans, null,
            "~",
            React.createElement("strong", null, requiredDiskSpace),
            "GB")));
}
//# sourceMappingURL=sequence-disk-space.js.map