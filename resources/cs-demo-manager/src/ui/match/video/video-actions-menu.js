...
function useGetVideoCommandConfig() {
...
export function VideoActionsMenu() {
        ...
        if (!canceled && filePath) {
            try {
                ...
                showToast({
                    ...
                    content: React.createElement(Trans, { context: "Toast" }, "File created, click here to reveal it"),
                    type: 'success',
                    onClick: () => {
    ...
    return (React.createElement(KebabMenu, { label: t `Video actions` },
        React.createElement(KebabMenuItem, { onClick: onCopyClick },
            React.createElement(Trans, { context: "Button" }, "Copy as JSON")),
        React.createElement(KebabMenuItem, { onClick: onExportClick },
            React.createElement(Trans, { context: "Button" }, "Export as JSON"))));
}
//# sourceMappingURL=video-actions-menu.js.map