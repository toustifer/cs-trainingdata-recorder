...
function buildSequencesGroup(sequences, pixelsPerTick, ticksPerSecond, setSelectedSequenceOnTimeline) {
    ...
    for (let index = 0; index < sortedSequences.length; index++) {
        ...
        items.push({
            ...
            y: currentY,
            height: itemHeight,
            element: (React.createElement(SequenceItem, { sequence: sequence, ticksPerSecond: ticksPerSecond, onEditClick: setSelectedSequenceOnTimeline })),
        });
    }
    return {
        id: 'sequences',
...
export function SequencesTimeline() {
    ...
    const [selectedSequenceOnTimeline, setSelectedSequenceOnTimeline] = useState(undefined);
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "flex border border-gray-900" },
            React.createElement("div", { ...wrapperProps },
                React.createElement("div", { ...timelineProps }, render(groups)))),
        React.createElement(EditSequenceDialog, { sequence: selectedSequenceOnTimeline, closeDialog: () => setSelectedSequenceOnTimeline(undefined) })));
}
//# sourceMappingURL=sequences-timeline.js.map