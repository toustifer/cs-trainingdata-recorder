...
export function PreviousRoundButton() {
    ...
    return (React.createElement(PlaybackBarButton, { onClick: onClick, isDisabled: isDisabled },
        React.createElement(StepBackwardIcon, { className: "h-20" })));
}
//# sourceMappingURL=previous-round-button.js.map