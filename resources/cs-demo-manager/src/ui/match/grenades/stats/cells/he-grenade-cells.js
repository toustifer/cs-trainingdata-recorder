...
export function HeGrenadeCells({ playerSteamId }) {
    const match = useCurrentMatch();
    const playerDamages = match.damages.filter((damage) => damage.attackerSteamId === playerSteamId &&
    ...
    const killCount = match.kills.filter((kill) => {
        return (kill.killerSteamId === playerSteamId &&
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Cell, null,
            React.createElement(CellText, null, heGrenadeThrownCount)),
        React.createElement(Cell, null,
            React.createElement(CellText, null, totalDamageCount)),
        React.createElement(Cell, null,
            React.createElement(CellText, null, damagePerThrow)),
        React.createElement(Cell, null,
            React.createElement(CellText, null, enemiesDamagedPerHeGrenadeCount)),
        React.createElement(Cell, null,
            React.createElement(CellText, null, damagePerRound)),
        React.createElement(Cell, null,
            React.createElement(CellText, null, killCount))));
}
//# sourceMappingURL=he-grenade-cells.js.map