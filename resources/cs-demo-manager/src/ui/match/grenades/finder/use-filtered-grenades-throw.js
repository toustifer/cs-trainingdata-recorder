...
export function useFilteredGrenadesThrow(grenadesThrow) {
    ...
    let filteredGrenadesThrow = grenadesThrow.filter((grenadeThrow) => {
...
//# sourceMappingURL=use-filtered-grenades-throw.js.map