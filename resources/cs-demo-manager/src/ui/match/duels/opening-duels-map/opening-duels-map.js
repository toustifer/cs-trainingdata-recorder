...
export function OpeningDuelsMap({ map, kills }) {
    ...
    const { setCanvas, interactiveCanvas } = useMapCanvas({
        ...
        onContextMenu: (event) => {
            ...
            table.selectRow(killId);
            table.scrollToRow(killId);
            showContextMenu(event, React.createElement(OpeningDuelContextMenu, { kill: hoveringKill, onWatchClick: onWatchClick }));
        },
    });
    ...
    const renderTooltip = () => {
        ...
        return (React.createElement(KillFeedEntry, { kill: hoveringKill, timeElapsedOption: {
    ...
    return (React.createElement("div", { className: "flex h-full" },
        React.createElement("div", { className: "mr-12 flex max-w-[488px] flex-1 flex-col gap-12" },
            ...
            React.createElement("div", { className: "flex gap-12" },
                React.createElement(SideSelect, { selectedSides: selectedSides, onChange: (selectedSide) => {
        ...
        React.createElement("div", { className: "relative flex flex-1 bg-gray-50", ref: setWrapper },
            React.createElement("div", { className: "absolute top-0 size-full overflow-hidden" },
                React.createElement("canvas", { ref: (ref) => {
                    ...
                    }, width: canvasSize.width, height: canvasSize.height, ...getReferenceProps() }),
                isTooltipVisible && node))));
}
//# sourceMappingURL=opening-duels-map.js.map