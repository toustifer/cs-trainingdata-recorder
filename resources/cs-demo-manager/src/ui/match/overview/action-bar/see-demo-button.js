...
export function SeeDemoButton() {
    ...
    const onClick = async () => {
        ...
        if (demoExists) {
            ...
            showDialog(React.createElement(UpdateDemoLocationDialog, { checksum: match.checksum, demoFilePath: match.demoFilePath }));
        }
    };
    return React.createElement(CommonSeeDemoButton, { onClick: onClick });
}
