...
export function TeamsEconomyBreakdownChart() {
    ...
    const tooltip = {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        formatter: (params) => {
            const { seriesName: teamName, value: money, data, marker, name: roundNumber, } = params;
    ...
    return (React.createElement(Panel, { header: React.createElement(PanelTitle, null,
            React.createElement(Trans, null, "Breakdown")) },
        React.createElement(TeamEconomyCards, null),
        React.createElement("div", { className: "flex justify-center" },
            React.createElement("div", { ref: chartRefTeamA, style: style }),
            React.createElement("div", { className: "my-[38px] flex flex-col justify-around" }, match.rounds.map((round) => {
                ...
                return (React.createElement("div", { className: "flex w-[50px]", key: round.number, style: {
                        justifyContent: isWinnerTeamA ? 'flex-start' : 'flex-end',
                    } },
                    React.createElement(Tooltip, { content: React.createElement(Trans, { context: "Chart tooltip" },
                            winnerTeamName,
                            " won the round ",
                            roundNumber), delay: 100 },
                        React.createElement("div", null,
                            React.createElement(Icon, { color: iconColor, width: 20 })))));
            })),
            React.createElement("div", { ref: chartRefTeamB, style: style }))));
}
//# sourceMappingURL=team-economy-breakdown-chart.js.map