...
export function TeamEconomyAdvantageChart() {
    ...
    const option = {
        ...
        tooltip: {
            ...
            formatter: (params) => {
                const { seriesName: teamName, value } = params;
    ...
    return (React.createElement(Panel, { header: React.createElement(PanelTitle, null,
            React.createElement(Trans, null, "Advantage")) },
        React.createElement("div", { className: "min-h-[400px]", ref: ref })));
}
//# sourceMappingURL=team-economy-advantage-chart.js.map