...
export function EndReason() {
    ...
    return (React.createElement(Panel, { header: React.createElement(Trans, { context: "Panel title" }, "Round end reason"), fitHeight: true },
        React.createElement("p", null, endReasonText)));
}
//# sourceMappingURL=end-reason.js.map