...
export function PlayDemoAtTickButton({ tick, focusSteamId, demoPath, game, tooltip, size = 30 }) {
    ...
    return (React.createElement(Tooltip, { content: tooltip, placement: "left" },
        React.createElement("div", { className: "transition duration-300 hover:text-gray-900", onClick: onClick },
            React.createElement(PlayCircleIcon, { height: size }))));
}
//# sourceMappingURL=play-demo-at-tick-button.js.map