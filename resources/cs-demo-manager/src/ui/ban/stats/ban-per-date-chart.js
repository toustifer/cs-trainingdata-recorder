...
function useGetTimeAxisLabel() {
    ...
    const getTimeAxisLabel = (timestamp) => {
        const formatOptions = {
            year: 'numeric',
            month: 'numeric',
        };
...
export function BanPerDateChart({ bannedAccounts }) {
    ...
    return (React.createElement(Panel, { header: React.createElement(PanelTitle, null,
            React.createElement(Trans, null, "Ban count over time")) }, bansCount.length > 0 ? React.createElement("div", { className: "min-h-[400px]", ref: ref }) : React.createElement(NoBanMessage, null)));
}
//# sourceMappingURL=ban-per-date-chart.js.map