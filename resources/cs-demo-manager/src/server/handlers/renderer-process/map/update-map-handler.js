...
export async function updateMapHandler({ id, name, game, posX, posY, thresholdZ, lowerRadarBase64, radarBase64, scale, thumbnailBase64, }) {
    try {
...
//# sourceMappingURL=update-map-handler.js.map