...
export async function addMapHandler({ name, game, posX, posY, thresholdZ, scale, lowerRadarBase64, radarBase64, thumbnailBase64, }) {
    try {
        ...
        const map = await mapRowToMap(insertedMaps[0]);
        return map;
    }
    catch (error) {
...
//# sourceMappingURL=add-map-handler.js.map