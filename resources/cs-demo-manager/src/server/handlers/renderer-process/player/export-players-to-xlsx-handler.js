...
export async function exportPlayersToXlsxHandler(payload) {
    try {
        ...
        const successPayload = payload.exportEachPlayerToSingleFile
            ? {
                outputType: 'folder',
...
//# sourceMappingURL=export-players-to-xlsx-handler.js.map