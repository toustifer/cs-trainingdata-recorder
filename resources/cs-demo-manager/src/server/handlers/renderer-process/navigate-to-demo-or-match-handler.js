...
export async function navigateToDemoOrMatch(demoPath) {
    const isDemoInDatabase = await isDemoByPathInDatabase(demoPath);
    if (isDemoInDatabase) {
...
//# sourceMappingURL=navigate-to-demo-or-match-handler.js.map