...
async function deleteHlaeRawFiles(sequenceName, outputFolderPath, recordingOutput) {
 ...
 */
async function deleteCs2RawFiles(csgoFolderPath) {
 ...
 */
async function deleteCsgoRawFiles(csgoFolderPath, sequenceName) {
...
async function deleteStartMovieRawFiles(sequenceName, game) {
...
export async function deleteSequencesRawFiles({ sequences, recordingSystem, outputFolderPath, game, recordingOutput, }) {
...
//# sourceMappingURL=delete-sequences-raw-files.js.map