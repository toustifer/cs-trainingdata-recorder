...
async function assertWavFileExists(wavFilePath) {
...
async function assertVideoFileExists(videoFilePath) {
...
async function assertFolderExists(folderPath) {
...
function assertPathsNotEmpty(paths) {
    if (paths.length === 0) {
        logger.error('No paths found');
        throw new RawFilesNotFoundError();
    }
}
export async function getHlaeTakeFolderPath(sequenceOutputFolderPath) {
...
async function getHlaeRawFiles({ sequence, game, outputFolderPath, recordingOutput, videoContainer, recordAudio, }) {
...
export async function getStartMovieRawFiles({ sequence, game }) {
...
export async function getSequenceRawFiles({ recordingSystem, recordingOutput, videoContainer, sequence, game, outputFolderPath, recordAudio, }) {
...
//# sourceMappingURL=get-sequence-raw-files.js.map