...
export async function downloadAndExtractVirtualDub() {
    ...
    const zipFilename = process.arch === 'x64' ? `VirtualDub-${VIRTUALDUB_VERSION}-AMD64` : `VirtualDub-${VIRTUALDUB_VERSION}`;
...
//# sourceMappingURL=download-and-extract-virtual-dub.js.map