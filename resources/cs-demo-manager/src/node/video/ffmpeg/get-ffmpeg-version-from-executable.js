...
export async function getFfmpegVersionFromExecutable(executablePath) {
    return new Promise((resolve, reject) => {
        exec(`"${executablePath}" -version`, { windowsHide: true }, (error, stdout) => {
            ...
            const results = /ffmpeg version (?:n)?([0-9]+\.[0-9]+(?:\.[0-9]+)?|[0-9]{4}-[0-9]{2}-[0-9]{2}-git-[a-z0-9]+)(?:-[^-\s]+)?/.exec(stdout);
...
//# sourceMappingURL=get-ffmpeg-version-from-executable.js.map