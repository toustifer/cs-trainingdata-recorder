...
export async function getHlaeVersionFromExecutable(executablePath) {
    ...
    return new Promise((resolve, reject) => {
        ...
        exec(`powershell -Command "(Get-Item '${sanitizedExecutablePath}').VersionInfo.FileVersion"`, { windowsHide: true }, (error, stdout) => {
            if (error) {
...
//# sourceMappingURL=get-hlae-version-from-executable.js.map