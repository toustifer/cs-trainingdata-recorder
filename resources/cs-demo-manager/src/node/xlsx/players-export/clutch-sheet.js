...
import { fetchPlayersClutchStats } from 'csdm/node/database/players/fetch-players-clutch-stats';
export class ClutchSheet extends MultiplePlayerExportSheet {
    getName() {
        return 'Clutch';
    }
    getColumns() {
...
//# sourceMappingURL=clutch-sheet.js.map