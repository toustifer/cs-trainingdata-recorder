...
export async function getCsgoFolderPath() {
    ...
    const data = VDF.parse(vdfContent);
...
function buildFolderPathFromCustomExecutablePath(customExecutablePath, game) {
...
export async function getCsgoFolderPathOrThrow(game) {
    let folderPath;
...
//# sourceMappingURL=get-csgo-folder-path.js.map