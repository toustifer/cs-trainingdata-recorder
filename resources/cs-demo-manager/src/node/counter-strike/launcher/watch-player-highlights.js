...
function assertPlayerHasActions(match) {
    if (match.actions.length === 0) {
        throw new NoKillsFound();
    }
}
export async function watchPlayerHighlights({ demoPath, steamId, perspective, onGameStart }) {
...
//# sourceMappingURL=watch-player-highlights.js.map