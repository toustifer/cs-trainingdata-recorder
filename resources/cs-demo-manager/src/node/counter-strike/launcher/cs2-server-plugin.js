...
function getGameInfoFilePathFromGamePath(executablePath) {
    return path.join(executablePath, 'game', 'csgo', 'gameinfo.gi');
}
function getServerPluginFolderFromGamePath(executablePath) {
    return path.join(executablePath, 'game', 'csgo', 'csdm');
}
async function deleteLogFile(csgoFolderPath) {
...
//# sourceMappingURL=cs2-server-plugin.js.map