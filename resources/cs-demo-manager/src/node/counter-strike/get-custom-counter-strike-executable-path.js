...
export async function getCustomCounterStrikeExecutablePath(game) {
    const { playback: { csgoExecutablePath, cs2ExecutablePath, customCs2LocationEnabled, customCsgoLocationEnabled }, } = await getSettings();
...
//# sourceMappingURL=get-custom-counter-strike-executable-path.js.map