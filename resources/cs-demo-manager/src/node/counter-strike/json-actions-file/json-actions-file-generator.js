...
export class JSONActionsFileGenerator {
    ...
    sequences = [];
    game;
    constructor(demoPath, game) {
        this.game = game;
        this.filePath = windowsToUnixPathSeparator(`${demoPath}.json`);
    }
    addSkipAhead(startTick, toTick) {
        this.actions.push({
...
//# sourceMappingURL=json-actions-file-generator.js.map