...
export async function areProcessesRunning(processNames) {
    if (isWindows) {
    ...
    const areRunning = await Promise.all(processNames.map((processName) => {
        return new Promise((resolve) => {
...
//# sourceMappingURL=are-processes-running.js.map