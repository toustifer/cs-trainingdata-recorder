...
export async function exportMatchesChatMessages(checksums, outputFolder) {
    let hasExportedAtLeastOneMatch = false;
    await Promise.all(checksums.map(async (checksum) => {
...
//# sourceMappingURL=export-matches-chat-messages.js.map