...
export async function startBoiler(options) {
    await assertSteamIsRunning();
    await killCounterStrikeProcesses();
    return new Promise((resolve, reject) => {
        const executablePath = path.join(getStaticFolderPath(), 'boiler-writter', isWindows ? 'boiler-writter.exe' : 'boiler-writter');
...
//# sourceMappingURL=start-boiler.js.map