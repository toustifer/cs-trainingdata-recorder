const createSmokesStartTable = {
    ...
    run: async (transaction) => {
        await transaction.schema
            ...
            .addForeignKeyConstraint('smokes_start_match_checksum_fk', ['match_checksum'], 'matches', ['checksum'], (cb) => cb.onDelete('cascade'))
            ...
            .execute();
        await transaction.schema
            .createIndex('smokes_start_match_checksum_round_number_idx')
            .ifNotExists()
            .on('smokes_start')
...
//# sourceMappingURL=create-smokes-start-table.js.map