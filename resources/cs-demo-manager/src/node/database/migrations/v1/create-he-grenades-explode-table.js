const createHeGrenadesExplodeTable = {
    schemaVersion: 1,
    run: async (transaction) => {
        await transaction.schema
            .createTable('he_grenades_explode')
            .ifNotExists()
            .addColumn('id', 'bigserial', (col) => col.primaryKey().notNull())
            .addColumn('match_checksum', 'varchar', (col) => col.notNull())
            .addForeignKeyConstraint('he_grenades_explode_match_checksum_fk', ['match_checksum'], 'matches', ['checksum'], (cb) => cb.onDelete('cascade'))
            ...
            .execute();
        await transaction.schema
            .createIndex('he_grenades_explode_match_checksum_round_number_idx')
            .ifNotExists()
            .on('he_grenades_explode')
            .columns(['match_checksum', 'round_number'])
            .execute();
    },
};
// eslint-disable-next-line no-restricted-syntax
export default createHeGrenadesExplodeTable;
//# sourceMappingURL=create-he-grenades-explode-table.js.map