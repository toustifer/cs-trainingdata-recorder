const createDecoysStartTable = {
    ...
    run: async (transaction) => {
        await transaction.schema
            ...
            .addForeignKeyConstraint('decoys_start_match_checksum_fk', ['match_checksum'], 'matches', ['checksum'], (cb) => cb.onDelete('cascade'))
...
//# sourceMappingURL=create-decoys-start-table.js.map