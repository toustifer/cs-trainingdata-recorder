const createFaceitMatchTeamsTable = {
    schemaVersion: 1,
    run: async (transaction) => {
        await transaction.schema
            ...
            .addForeignKeyConstraint('faceit_match_teams_match_id_fk', ['faceit_match_id'], 'faceit_matches', ['id'], (cb) => cb.onDelete('cascade'))
...
//# sourceMappingURL=create-faceit-match-teams-table.js.map