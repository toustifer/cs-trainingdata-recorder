const createFlashbangsExplodeTable = {
    schemaVersion: 1,
    run: async (transaction) => {
        await transaction.schema
            ...
            .addForeignKeyConstraint('flashbangs_explode_match_checksum_fk', ['match_checksum'], 'matches', ['checksum'], (cb) => cb.onDelete('cascade'))
...
//# sourceMappingURL=create-flashbangs-explode-table.js.map