const createGrenadeProjectilesDestroyTable = {
    schemaVersion: 1,
    run: async (transaction) => {
        await transaction.schema
            ...
            .addForeignKeyConstraint('grenade_projectiles_destroy_match_checksum_fk', ['match_checksum'], 'matches', ['checksum'], (cb) => cb.onDelete('cascade'))
...
//# sourceMappingURL=create-grenade-projectiles-destroy-table.js.map