const createClutchesTable = {
    ...
    run: async (transaction) => {
        await transaction.schema
            ...
            .addForeignKeyConstraint('clutches_match_checksum_fk', ['match_checksum'], 'matches', ['checksum'], (cb) => cb.onDelete('cascade'))
...
//# sourceMappingURL=create-clutches-table.js.map