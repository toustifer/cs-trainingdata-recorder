const createBombsPlantStartTable = {
    schemaVersion: 1,
    run: async (transaction) => {
        await transaction.schema
            ...
            .addForeignKeyConstraint('bombs_plant_start_match_checksum_fk', ['match_checksum'], 'matches', ['checksum'], (cb) => cb.onDelete('cascade'))
...
export default createBombsPlantStartTable;
//# sourceMappingURL=create-bombs-plant-start-table.js.map