const createHostageRescuedTable = {
    schemaVersion: 1,
    run: async (transaction) => {
        await transaction.schema
            ...
            .addForeignKeyConstraint('hostage_rescued_match_checksum_fk', ['match_checksum'], 'matches', ['checksum'], (cb) => cb.onDelete('cascade'))
...
//# sourceMappingURL=create-hostage-rescued-table.js.map