const createPlayerBuysTable = {
    ...
    run: async (transaction) => {
        await transaction.schema
            ...
            .addForeignKeyConstraint('player_buys_match_checksum_fk', ['match_checksum'], 'matches', ['checksum'], (cb) => cb.onDelete('cascade'))
...
//# sourceMappingURL=create-player-buys-table.js.map