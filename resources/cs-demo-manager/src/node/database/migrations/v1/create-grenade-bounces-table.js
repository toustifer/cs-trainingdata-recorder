const createGrenadeBouncesTable = {
    schemaVersion: 1,
    run: async (transaction) => {
        await transaction.schema
            .createTable('grenade_bounces')
            .ifNotExists()
            .addColumn('id', 'bigserial', (col) => col.primaryKey().notNull())
            .addColumn('match_checksum', 'varchar', (col) => col.notNull())
            .addForeignKeyConstraint('grenade_bounces_match_checksum_fk', ['match_checksum'], 'matches', ['checksum'], (cb) => cb.onDelete('cascade'))
            ...
            .execute();
        await transaction.schema
            .createIndex('grenade_bounces_match_checksum_round_number_idx')
            .ifNotExists()
            .on('grenade_bounces')
...
//# sourceMappingURL=create-grenade-bounces-table.js.map