const createFaceitMatchPlayersTable = {
    schemaVersion: 1,
    run: async (transaction) => {
        await transaction.schema
            ...
            .addForeignKeyConstraint('faceit_match_players_match_id_fk', ['faceit_match_id'], 'faceit_matches', ['id'], (cb) => cb.onDelete('cascade'))
...
//# sourceMappingURL=create-faceit-match-players-table.js.map