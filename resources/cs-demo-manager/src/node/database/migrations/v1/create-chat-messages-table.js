const createChatMessagesTable = {
    ...
    run: async (transaction) => {
        await transaction.schema
            ...
            .addForeignKeyConstraint('chat_messages_match_checksum_fk', ['match_checksum'], 'matches', ['checksum'], (cb) => cb.onDelete('cascade'))
...
//# sourceMappingURL=create-chat-messages-table.js.map