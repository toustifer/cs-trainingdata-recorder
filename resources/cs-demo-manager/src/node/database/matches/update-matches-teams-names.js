...
import { fetchTeamNamesPerChecksum, } from 'csdm/node/database/matches/fetch-team-names-per-checksum';
import { TeamsNotFound } from 'csdm/node/database/teams/errors/teams-not-found';
async function updateTeamName({ transaction, oldName, checksum, newName, letter, opponentTeamName, }) {
...
export async function updateMatchesTeamNames({ checksums, teamNameA, teamNameB, onProgress, signal, }) {
...
//# sourceMappingURL=update-matches-teams-names.js.map