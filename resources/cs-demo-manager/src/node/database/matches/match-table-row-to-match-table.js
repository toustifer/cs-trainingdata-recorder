export function matchTableRowToMatchTable(row, tagIds, collateralKillCountPerMatch, playersPerMatch) {
    return {
...
//# sourceMappingURL=match-table-row-to-match-table.js.map