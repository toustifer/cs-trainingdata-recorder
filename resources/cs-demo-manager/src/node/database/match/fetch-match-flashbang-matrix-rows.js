...
export async function fetchMatchFlashbangMatrixRows(checksum) {
    const result = await db
        ...
        sql `COALESCE(ROUND(AVG(pb.duration)::numeric, 2), 0)`.as('duration'),
    ])
...
//# sourceMappingURL=fetch-match-flashbang-matrix-rows.js.map