...
export async function fetchPlayersPositions(checksum, roundNumber) {
    const rows = await db
        ...
        .execute();
    const playerPositions = fillMissingTicks(rows.map(playerPositionRowToPlayerPosition));
    return playerPositions;
}
//# sourceMappingURL=fetch-players-positions.js.map