...
export async function fetchBannedSteamAccounts(ignoreBanBeforeFirstSeen) {
    ...
    const bannedAccounts = rows.map((row) => {
        return {
...
//# sourceMappingURL=fetch-banned-steam-accounts.js.map