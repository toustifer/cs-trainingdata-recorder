export function grenadeProjectileDestroyRowToGrenadeProjectileDestroy(row) {
    return {
        id: row.id,
        frame: row.frame,
        tick: row.tick,
...
//# sourceMappingURL=grenade-projectile-destroy-row-to-grenade-projectile-destroy.js.map