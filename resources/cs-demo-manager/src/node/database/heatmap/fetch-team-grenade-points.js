...
export async function fetchTeamGrenadePoints(filters) {
    const grenadeNames = [];
    ...
    if (filters.players.length > 0) {
        query = query.where('thrower_steam_id', 'in', filters.players.map((player) => player.steamId));
    }
...
//# sourceMappingURL=fetch-team-grenade-points.js.map