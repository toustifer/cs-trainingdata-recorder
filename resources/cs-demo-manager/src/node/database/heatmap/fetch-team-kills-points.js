...
function buildQuery(filters) {
    ...
    if (filters.players.length > 0) {
        query = query.where('kills.killer_steam_id', 'in', filters.players.map((player) => player.steamId));
    }
...
export async function fetchTeamKillsPoints(filters) {
...
//# sourceMappingURL=fetch-team-kills-points.js.map