...
async function getPlayerSteamIdFromPlayerId(playerProfile) {
    const steamApiKey = await getSteamApiKey();
    const response = await fetch(`https://api.steampowered.com/ISteamUser/ResolveVanityURL/v0001/?key=${steamApiKey}&vanityurl=${playerProfile}`);
 ...
 *
 */
export async function getPlayerSteamIdFromSteamUrl(url) {
...
//# sourceMappingURL=get-player-steam-id-from-steam-url.js.map