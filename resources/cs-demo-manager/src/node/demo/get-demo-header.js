...
function removeNullBytesFromString(value) {
    return value.replaceAll('\0', '');
}
function removeUnicodeReplacementChars(value) {
    return value.replaceAll('\uFFFD', '');
}
function readSource1DemoHeader(buffer) {
...
function readSource2DemoHeader(buffer) {
...
export async function getDemoHeader(demoFilePath) {
...
//# sourceMappingURL=get-demo-header.js.map