...
function getDemoSource(demoHeader, demoName) {
...
function getDemoMapNameFromHeader(demoHeader) {
...
async function updateDemoFromInfoFile(demo) {
    try {
...
async function buildDemoFromFilePath(filePath) {
...
export async function getDemoFromFilePath(filePath) {
...
//# sourceMappingURL=get-demo-from-file-path.js.map