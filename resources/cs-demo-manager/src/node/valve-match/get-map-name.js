 ...
 */
export function getMapName(gameType) {
    ...
    const mapping = {
        ...
        [1 << 7]: {
            ...
            [wingmanMode]: 'de_rooftop',
        },
        [1 << 8]: 'cs_office',
        [1 << 9]: 'de_brewery',
        [1 << 10]: 'de_transit', // when game mode is 10 (wingman), don't know when it's 8 (competitive)
        [1 << 11]: 'de_dogtown',
        [1 << 12]: 'de_cache',
        [1 << 13]: 'de_jura',
        [1 << 14]: 'de_golden',
...
//# sourceMappingURL=get-map-name.js.map