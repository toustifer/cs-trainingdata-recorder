...
export class JsonCommand extends ExportCommand {
    ...
    printHelp() {
        ...
        console.log('');
        console.log(`Usage: csdm ${JsonCommand.Name} demoPaths... ${this.formatFlagsForHelp(this.commonFlags)} ${this.formatFlagForHelp(this.minifyFlag)}`);
        console.log('');
        ...
        console.log(`    csdm ${JsonCommand.Name} "C:\\Users\\username\\Desktop\\MyFolder" ${this.outputFolderFlag} "C:\\Users\\username\\Documents" ${this.sourceFlag} esl`);
    }
    async run() {
