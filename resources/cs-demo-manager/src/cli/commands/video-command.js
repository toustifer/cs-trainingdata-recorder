...
export class VideoCommand extends Command {
    static Name = 'video';
    outputFlag = 'output';
    framerateFlag = 'framerate';
    widthFlag = 'width';
    heightFlag = 'height';
    closeGameAfterRecordingFlag = 'close-game-after-recording';
    noCloseGameAfterRecordingFlag = 'no-close-game-after-recording';
    concatenateSequencesFlag = 'concatenate-sequences';
    noConcatenateSequencesFlag = 'no-concatenate-sequences';
    encoderSoftwareFlag = 'encoder-software';
    recordingSystemFlag = 'recording-system';
    recordingOutputFlag = 'recording-output';
    ffmpegExecutablePathFlag = 'ffmpeg-executable-path';
    ffmpegCrfFlag = 'ffmpeg-crf';
    ffmpegAudioBitrateFlag = 'ffmpeg-audio-bitrate';
    ffmpegVideoCodecFlag = 'ffmpeg-video-codec';
    ffmpegAudioCodecFlag = 'ffmpeg-audio-codec';
    ffmpegVideoContainerFlag = 'ffmpeg-video-container';
    ffmpegInputParametersFlag = 'ffmpeg-input-parameters';
    ffmpegOutputParametersFlag = 'ffmpeg-output-parameters';
    showXRayFlag = 'show-x-ray';
    noShowXRayFlag = 'no-show-x-ray';
    showAssistsFlag = 'show-assists';
    noShowAssistsFlag = 'no-show-assists';
    showOnlyDeathNoticesFlag = 'show-only-death-notices';
    noShowOnlyDeathNoticesFlag = 'no-show-only-death-notices';
    recordAudioFlag = 'record-audio';
    noRecordAudioFlag = 'no-record-audio';
    playerVoicesFlag = 'player-voices';
    noPlayerVoicesFlag = 'no-player-voices';
    deathNoticesDurationFlag = 'death-notices-duration';
    cfgFlag = 'cfg';
    focusPlayerFlag = 'focus-player';
    configFileFlag = 'config-file';
    modeFlag = 'mode';
    eventFlag = 'event';
    steamIdsFlag = 'steamids';
    perspectiveFlag = 'perspective';
    roundsFlag = 'rounds';
    startSecondsBeforeFlag = 'start-seconds-before';
    endSecondsAfterFlag = 'end-seconds-after';
    outputFolderPath;
    demoPath = '';
    startTick = 0;
    endTick = 0;
    ...
    ffmpegVideoCodec;
    ffmpegAudioCodec;
    ffmpegVideoContainer;
    ffmpegInputParameters;
    ...
    printHelp() {
        ...
        console.log(`       csdm ${VideoCommand.Name} <demoPath> --mode ${Mode.Player} --steamids <id1,id2> --event <event> [options]`);
        console.log('');
        ...
        console.log(`  --${this.perspectiveFlag} <string> (${Object.values(PerspectiveType).join('|')}, default: ${PerspectiveType.Player})`);
        console.log(`  --${this.roundsFlag} <number,number,...> (comma-separated list of round numbers to filter)`);
        console.log(`  --${this.startSecondsBeforeFlag} <number> (seconds before event to start sequence, default: ${this.startSecondsBefore})`);
        console.log(`  --${this.endSecondsAfterFlag} <number> (seconds after event to end sequence, default: ${this.endSecondsAfter})`);
    }
    async run() {
        try {
    ...
    async parseArgs() {
        ...
        if (values[this.focusPlayerFlag]) {
            this.focusPlayerSteamId = values[this.focusPlayerFlag];
        }
    }
}
