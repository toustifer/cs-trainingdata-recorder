...
export class DownloadRenownCommand extends DownloadBaseCommand {
    ...
    printHelp() {
        ...
        console.log('');
        console.log(`Usage: csdm ${DownloadRenownCommand.Name} ${this.formatFlagsForHelp([this.outputFlag, this.steamIdFlag])}`);
        console.log('');
...
//# sourceMappingURL=download-renown-command.js.map