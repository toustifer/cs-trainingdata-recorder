...
export class AnalyzeCommand extends Command {
    ...
    forceAnalyze = false;
    source = undefined;
    temporaryFolderPath = path.resolve(os.tmpdir(), 'cs-demo-manager-cli');
    sourceFlag = '--source';
    forceFlag = '--force';
    analyzePositionsFlag = '--analyze-positions';
    getDescription() {
    ...
    printHelp() {
        ...
        console.log('');
        console.log(`Usage: csdm ${AnalyzeCommand.Name} demoPaths... ${this.formatFlagsForHelp([this.sourceFlag, this.forceFlag, this.analyzePositionsFlag])}`);
        console.log('');
        console.log('Demos path can be either a .dem files path or a directory. It can be relative or absolute.');
        console.log('');
        console.log(`The ${this.sourceFlag} flag forces the analysis logic of the demo analyzer. Available values: [${sourceValues}]`);
        console.log(`The ${this.forceFlag} flag forces demos analyzes even if they are already in the database.`);
        console.log(`The ${this.analyzePositionsFlag} flag indicates to includes players,projectiles... positions in the analysis.`);
        console.log('');
        ...
        console.log(`    csdm ${AnalyzeCommand.Name} "C:\\Users\\username\\Desktop\\demo.dem" "C:\\Users\\username\\Desktop\\demo2.dem"`);
        console.log('');
        console.log('Analyze all demos in a directory using the ESL analyzer and re-analyze demos that have already been analyzed:');
        console.log(`    csdm ${AnalyzeCommand.Name} "C:\\Users\\username\\Desktop\\MyFolder" ${this.sourceFlag} esl ${this.forceFlag}`);
    }
    async run() {
