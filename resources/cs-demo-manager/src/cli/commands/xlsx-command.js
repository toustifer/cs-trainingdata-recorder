...
export class XlsxCommand extends ExportCommand {
    ...
    printHelp() {
        ...
        console.log('');
        console.log(`Usage: csdm ${XlsxCommand.Name} demoPaths... ${this.commonFlags.map((flag) => `[${flag}]`)} [${this.singleFlag}] [${this.sheetsFlag}]`);
        console.log('');
        ...
        console.log(`The ${this.sheetsFlag} flag includes only sheets identified by its name. Available values: [${Object.values(SheetName).join(',')}]`);
        ...
        console.log(`    csdm ${XlsxCommand.Name} "C:\\Users\\username\\Desktop\\demo.dem" "C:\\Users\\username\\Desktop\\demo2.dem" ${this.sheetsFlag} rounds,kills`);
        console.log('');
        console.log('Export all demos in a directory using the ESL analyzer and save it in a custom directory:');
        console.log(`    csdm ${XlsxCommand.Name} "C:\\Users\\username\\Desktop\\MyFolder" ${this.outputFolderFlag} "C:\\Users\\username\\Documents" ${this.sourceFlag} esl`);
    }
    async run() {
...
//# sourceMappingURL=xlsx-command.js.map