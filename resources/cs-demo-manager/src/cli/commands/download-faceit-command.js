...
export class DownloadFaceitCommand extends DownloadBaseCommand {
    ...
    printHelp() {
        ...
        console.log('');
        console.log(`Usage: csdm ${DownloadFaceitCommand.Name} ${this.formatFlagsForHelp([this.outputFlag, this.nicknameFlag])}`);
        console.log('');
    ...
    async run() {
        console.warn(`This command is currently disabled, see https://cs-demo-manager.com/docs/guides/downloads#why-faceit-downloads-are-disabled.`);
        return;
        this.parseArgs();
...
//# sourceMappingURL=download-faceit-command.js.map