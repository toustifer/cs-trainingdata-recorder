...
import { getDefaultCs2Folders, getDefaultCsgoFolders, } from 'csdm/node/counter-strike/get-default-counter-strike-folders';
import { isPathWritable } from 'csdm/node/filesystem/is-path-writable';
export class DownloadBaseCommand extends Command {
    outputFolderPath = '';
    outputFlag = '--output';
    ...
    async assertOutputFolderIsValid(outputFolderPath) {
...
//# sourceMappingURL=download-base-command.js.map