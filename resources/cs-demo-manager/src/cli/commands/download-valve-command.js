...
import { buildMatchName, getLastRoundStatsMessage, } from 'csdm/node/valve-match/get-valve-match-from-match-info-protobuf-message';
...
export class DownloadValveCommand extends DownloadBaseCommand {
    static Name = 'dl-valve';
    shareCodes = [];
    demoPathBeingDownloaded;
    getDescription() {
    ...
    printHelp() {
        ...
        console.log(`    csdm ${DownloadValveCommand.Name} CSGO-XXXXX-XXXXX-XXXXX-XXXXX-XXXXX CSGO-XXXXX-XXXXX-XXXXX-XXXXX-XXXXX`);
        console.log('');
    ...
    async processMatchInfo(matchInfo) {
        const watchInfo = matchInfo.watchablematchinfo;
        const tvPort = watchInfo.tvPort;
        const serverIp = watchInfo.serverIp;
...
//# sourceMappingURL=download-valve-command.js.map