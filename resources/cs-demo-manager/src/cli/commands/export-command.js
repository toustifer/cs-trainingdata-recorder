...
export class ExportCommand extends Command {
    ...
    outputFolderPath = process.cwd();
    demosToExport = [];
    forceAnalyzeFlag = '--force-analyze';
    outputFolderFlag = '--output-folder';
    sourceFlag = '--source';
    commonFlags = [this.forceAnalyzeFlag, this.outputFolderFlag, this.sourceFlag];
    async run() {
    ...
    async assertOutputFolderIsValid() {
    ...
    async insertMatchInDatabase(checksum, demoPath) {
