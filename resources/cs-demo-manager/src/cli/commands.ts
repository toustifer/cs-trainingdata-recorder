...
import { TrainingDataCommand } from './commands/training-data-command';
import { QueryTrainingDataCommand } from './commands/query-training-data-command';
import { GenerateFramesCommand } from './commands/generate-frames-command';
...
export const commands = {
  ...
  [TrainingDataCommand.Name]: TrainingDataCommand,
  [QueryTrainingDataCommand.Name]: QueryTrainingDataCommand,
  [GenerateFramesCommand.Name]: GenerateFramesCommand,
};
